        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td>密码</td>
                        <td><s:textfield name="password" cssClass="InputStyle"></s:textfield></td>
                    </tr>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td>
                        	<s:select list="rlist" listKey="rid" listValue="name" name="rids" cssClass="SelectStyle" multiple="true"></s:select>
                        </td>
                    </tr>
                </table>
            </div>
