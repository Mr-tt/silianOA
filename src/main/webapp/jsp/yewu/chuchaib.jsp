...
<s:form action="chuchaiAction_add.action"  enctype="multipart/form-data" method="post">
	<table border=0 cellpadding=0 cellspacing=0 width=915 style='border-collapse:
	 ...
	 <tr height=23 style='height:17.0pt'>
	  ...
	  <td colspan=3 class=xl71 width=141 style='border-left:none;width:106pt'><s:textfield onfocus="new WdatePicker(this)" name="rq" id="rq" class="bt" style="width:139px;height:21px"></s:textfield> </td>
	 ...
	 <tr height=20 style='height:15.0pt'>
	  ...
	  <td colspan=3 class=xl65 width=141 style='border-left:none;width:106pt'><s:textfield onfocus="new WdatePicker(this)" name="yqwcrq" style="width:139px;height:43px"></s:textfield>　</td>
	 ...
	 <tr height=20 style='height:15.0pt'>
	  ...
	  class="font12">*</font></td>
	  <td colspan=2 class=xl78 width=170 style='border-left:none;width:127pt'>　<s:textfield onfocus="new WdatePicker(this)" name="fcfdsj" id="fcfdsj" class="bt" style="width:163px;height:61px"></s:textfield></td>
	  <td class=xl78 width=73 style='border-top:none;border-left:none;width:55pt'>企业性质<font
	  class="font12">*</font></td>
	  <td colspan=2 class=xl78 width=122 style='border-left:none;width:91pt'><s:select list="{'国企','私企','合资','外企','其他'}" name="qyxz" id="qyxz" class="bt" style="width:116px;height:38px"></s:select>　</td>
	 </tr>
	 <tr height=20 style='height:15.0pt'>
	  <td colspan=2 height=20 class=xl65 width=144 style='height:15.0pt;border-left:
	 ...
	 <tr>
         <td>file</td>
         <td id="more">
         <s:file name="zipai" value="上传自拍照" id="zipai"></s:file>
<!--          <input type="button" value="Add More.." onclick="addMore()" disabled="disabled">  -->        
		 </td>
     </tr>
	</table> <!-- onclick="return check()" -->
	<br><br>
	<input type="submit" value="提交审核"   id="tj" align="center"  onclick="return check()" style="width:70px;height:30px;color:black;align:center">
</s:form>
</body>
