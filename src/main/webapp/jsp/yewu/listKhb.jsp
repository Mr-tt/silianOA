    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle" >
        ...
        <thead>
            <tr align=center valign=middle id=TableTitle>
                ...
                <td width="100">地址</td>
                <td width="100">客户信息来源</td>
                <td width="100">预拜访日期</td>
        ...
        <!--显示数据列表-->
        <tbody id="TableData" class="dataContainer" datakey="khbs" >
          <s:iterator value="#khbs">
            <tr class="TableDetail1 template" align=center>
            	<s:hidden name="khbId"></s:hidden>
                <td ><s:property value="qy"/></td>
                <td ><s:property value="khmc"/></td>
                <td ><s:property value="dz"/></td>
                <td ><s:property value="khxxly"/></td>
                <td ><s:property value="ybf"/></td>
                <td ><s:property value="tbrq"/></td>
                <td ><s:property value="tbr"/></td>
               
               
                <%-- <td>
                	<s:a onClick="return delConfirm()" href="chuchaiAction_shenheUI.action?ccid=%{ccid}">删除</s:a> 
                    <s:a href="chuchaiAction_shenheUI.action?ccid=%{ccid}">查看审核</s:a>
                </td>--%>
            </tr>
          </s:iterator>
        </tbody>
