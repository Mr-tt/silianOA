...
<s:form action="loginAction_login.action">
    ...
    <DIV ID="CenterAreaBg">
        <DIV ID="CenterArea">
            <DIV ID="LogoImg" >
             	<h1>            	
             	 <img  src="${pageContext.request.contextPath}/image/logo.jpg" style="width:25px;height:25px">
             	 <font color="black">四联OA管理系统</font>
             	</h1>
            </DIV>
            <DIV ID="LoginInfo">
            ...
            <DIV ID="CopyRight"><A HREF="javascript:void(0)">&copy; 2017 版权所有 江西四联</A></DIV>
        </DIV>
    </DIV>
</s:form>
</BODY>
